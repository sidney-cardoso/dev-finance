...
const DOM = {
    ...
    innerHTMLTransaction(transaction, index) {
        ...
        <td><img onclick="Transactions.remove(${index})" src="./styles/assets/minus.svg" alt="Remover Transação" id="removeTransaction"/></td>
        `
        return html
    },
    ...
    updateBalance() {
        document.getElementById('incomeDisplay').innerHTML =
            Utils.formatCurrency(Transactions.incomes())
        document.getElementById('expenseDisplay').innerHTML =
            Utils.formatCurrency(Transactions.expenses())
        document.getElementById('totalDisplay').innerHTML =
            Utils.formatCurrency(Transactions.total())
    },
    clearTransactions() {
